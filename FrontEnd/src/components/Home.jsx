...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className="md:w-1/2 w-full">
        <h1 className="my-8 lg:text-4xl text-9xl md:w-4/6 font-medium text-[#333] lg:leading-normal leading-normal mb-3">
       <em> Paving the Path to Talent Discovery!</em>
        </h1>
        <p className="border-l-4 pl-2 py-5 mb-6 text-gray-500">
         Elevating Your Hiring Process, One Quiz at a Time!{" "}
        </p>
